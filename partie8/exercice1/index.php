...
<body>
  ...
  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active" title="nothing">
      <div class="d-flex w-50 justify-content-between">
        <h1 class="mb-1 text-center">Exercice 1 Partie 8 PHP</h1>
      </div>
      <p class="mb-1">
        <p>User Agent est : <?= $user ?></p>
        <p>Adresse IP : <?= $ip ?> </p>
        <p>Nom de serveur : <?= $name ?></p>
      </p>
    </a>
  </div>
</body>
