    ...
    <div class="list-group">
      <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
        <div class="d-flex w-50 justify-content-between">
          <h5 class="mb-1 text-center">Exercice 3 Partie 3 PHP</h5>
        </div>
        <p class="mb-1">
          <?php
          // On fait une boucle while qui va refaire les instructions jusqu'à ce qu'il arrive à 10.
            while($firstNumber > 10){
          //On créer une nouvelle variable qui stocke la multiplication des deux variables.
                $result = $firstNumber * $secondNumber;
          //On affiche le résultat de l'opération.
                echo $result.' ';
          //On décrémente de 1 la variable $firstNumber.
                $firstNumber--;
            }
          ?>
        </p>
