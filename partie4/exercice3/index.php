  ...
  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
      <div class="d-flex w-50 justify-content-between">
        <h1 class="mb-1 text-center">Exercice 3 Partie 4 PHP</h1>
      </div>
      <p class="mb-1">
        <?php
        function characteres($word2, $word1){
          return $word1.$word2;
        }
        //$word1 et $word2 correspondent aux paremètres du echo et non à la ligne n°1 ou 2.
        echo characteres('Bonjour', 'Virginie');
        echo characteres('Bonjour', 'Jo');
        ?>
      </p>
    </a>
  </div>
