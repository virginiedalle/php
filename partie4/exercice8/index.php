<?php
// Dans les paramètres, on met = avec le nombre pour définir une valeur par défaut.
function numbers($number1 = 100, $number2 = 20, $number3 = 5) {
  ...
  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
      <div class="d-flex w-50 justify-content-between">
        <h5 class="mb-1 text-center">Exercice 8 Partie 4 PHP</h5>
      </div>
      <p class="mb-1">
        <?php
        //On affiche la fonction avec les paramètres vides, car ils sont définis par défaut.
        echo numbers();
        ?>
      </p>
    </a>
